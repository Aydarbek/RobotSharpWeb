...
<html lang="en">
    ...
    <body>	
		<div class="navbar mb-4 text-white bg-success">
            <span>
                Условие задачи № <span id="taskInfo_taskId"></span> ::
                <strong><span id="taskInfo_title"></span></strong>
            </span>
		...
		<div class="container-fluid px-4">
			<div class="row">
				<div class="col-9 h-100">
					...
					<div class="row">
						<div class="col-12">
							<div id="taskInfo_problem" class="task-text">
							</div>
						</div>
					</div>
					<div class="row">
						<div class="col-12">
							...
							<div class="embed-responsive embed-responsive-16by9">
								<iframe id="taskInfo_video" class="embed-responsive-item" frameborder="0"></iframe>
							</div>
						</div>
					</div>
				</div>
				<div class="col-3">
					...
					<div class="col-12 example">
						...
						<textarea id="testOut" class="form-control text-white bg-success" rows="5"></textarea>
					</div>
				</div>
			</div>
        </div>
